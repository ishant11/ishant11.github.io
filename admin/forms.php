...
SEMINAR Name : <input type="text" name="s_name" /><br><br>
SEMINAR date : <input type="date" name="s_date" /><br><br>
SEMINAR desc : <input type="text" name="s_desc" /><br><br>
SEMINAR Cordinator: <input type="text" name="s_cord" /><br><br>

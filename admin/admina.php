...
<td style="border:solid 8px green;background-color:white; border-radius:5px;"> <a class="btn btn-danger btn-lg" href="erasea.php?id=<?php echo $row['activity_id'] ?>">ERASE</a></td>
</tr><?php }
?>
</table>
</center>

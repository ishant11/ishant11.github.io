		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-bars"></i>PLACEMENTS</li>
...
<td><b>p_date</td>
<td><b>p_by_name</td>
<td><b>p_by_company</td>
<td><b>p_cordinator</td>
<td><b>p_desc</td></b>
<td><B>erase data</td>
</tr>			 
			 <?php
...
while($row=mysql_fetch_assoc($r))
{
	...
	<tr>
<td  style="border:solid 10px green;background-color:white; border-radius:5px;"><h3><?php echo $row['p_id'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_title'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_date'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_by_name'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_by_company'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_cordinator'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['p_desc'];?></td>
<td style="border:solid 8px green;background-color:white; border-radius:5px;"> <a class="btn btn-danger btn-lg" href="erasep.php?id=<?php echo $row['p_id'] ?>">ERASE</a></td>
</tr><?php }?>
</table>

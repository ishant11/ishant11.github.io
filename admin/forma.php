		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-square-o"></i>ACTIVITIES</li>
...
ACTIVITY Name : <input type="text" name="a_name" /><br><br>
ACTIVITY date : <input type="date" name="a_date" /><br><br>
ACTIVITY desc : <input type="text" name="a_desc" /><br><br>
ACTIVITY Cordinator: <input type="text" name="a_cord" /><br><br>

		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-bars"></i>GUEST LECTURES</li>
...
<td><h5><b>lect_id</td>
<td><b>lect_title</td>
<td><b>lect_by_name</td>
<td><b>lect_by_desc</td>
<td><b>lect_date</td>
<td><b>lect_timing</td>
<td><B>lect_cordinator</td>
<td><B>erase data</td>
...
<td  style="border:solid 10px green;background-color:white; border-radius:5px;"><h3><?php echo $row['lect_id'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_title'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_by_name'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_by_desc'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_date'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_timing'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['lect_cordinator'];?></td>
<td style="border:solid 8px green;background-color:white; border-radius:5px;"> <a class="btn btn-danger btn-lg" href="eraseg.php?id=<?php echo $row['lect_id'] ?>">ERASE</a></td>
</tr><?php }?>
</table>
              <!-- page end-->
          </section>

...
LECTURE TITLE : <input type="text" name="g_title" /><br><br>
LECTURE BY NAME : <input type="text" name="g_by_name" /><br><br>
LECTURE BY DESC : <input type="text" name="g_desc" /><br><br>
LECTURE DATE: <input type="date" name="g_date" /><br><br>
LECTURE TIMING: <input type="text" name="g_timing" /><br><br>
LECTURE CORDINATOR: <input type="text" name="g_cord" /><br><br>

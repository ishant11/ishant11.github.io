...
<tr>
<td  style="border:solid 10px green;background-color:white; border-radius:5px;"><h3><?php echo $row['event_id'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['event_name'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['event_date'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['event_desc'];?></td>
<td  style="border:solid 8px green;background-color:white; border-radius:5px;"><?php echo $row['event_cordinator'];?></td>
<td style="border:solid 8px green;background-color:white; border-radius:5px;"> <a class="btn btn-danger btn-lg" href="erasee.php?id=<?php echo $row['event_id'] ?>">ERASE</a></td>
</tr><?php }?>
</table>
              <!-- page end-->
          </section>

...
PLACEMENT TITLE : <input type="text" name="p_title" /><br><br>
PLACEMENT BY NAME : <input type="text" name="p_by_name" /><br><br>
PLACEMENT BY COMPANY : <input type="text" name="p_by_company" /><br><br>
PLACEMENT DATE: <input type="date" name="p_date" /><br><br>
PLACEMENT DESCRIPTION: <input type="text" name="p_desc" /><br><br>
PLACEMENT CORDINATOR: <input type="text" name="p_cord" /><br><br>
